...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Smart and simple solution to handle custom error codes and messages}
  spec.description   = %q{Smart and simple solution to handle custom error codes and messages}
